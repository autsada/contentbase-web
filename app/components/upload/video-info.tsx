...
export function UploadVideoInfo({ closeModal }: Props) {
  ...
  return (
    <div className="fixed z-[10010] inset-0 h-screen py-5 px-2 ">
      <Backdrop />
      <form className="w-full h-full bg-white pt-6 pb-10 px-5 rounded-xl max-h-full">
        <button
