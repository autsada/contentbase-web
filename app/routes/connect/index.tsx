...
export default function Connect() {
  ...
  return (
    <div className="absolute inset-0 bg-gray-50 text-center py-10 opacity-[98%]">
      ...
      <div className="px-10 mb-6">
        <Link
          ...
          className="btn-light bg-white flex justify-between items-center w-64 h-11 rounded-full mx-auto px-5 hover:bg-neutral-100"
        >
      ...
      <div className="px-10">
        <div className="btn-dark flex justify-between items-center w-64 h-11 rounded-full mx-auto px-5">
          <div className="w-12 flex justify-center items-center">
            <FaGoogle size={16} color="white" />
          </div>
          <button className="w-full ml-5 flex justify-start items-center focus:outline-none text-white">
            Connect with Google
          </button>
        </div>
      </div>
